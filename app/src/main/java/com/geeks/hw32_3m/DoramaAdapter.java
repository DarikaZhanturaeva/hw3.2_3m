...
import com.geeks.hw32_3m.databinding.ItemDoramsBinding;
...
public class DoramaAdapter extends RecyclerView.Adapter<DoramaViewHolder> {
    ...
    public DoramaViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new DoramaViewHolder(ItemDoramsBinding.inflate(LayoutInflater.from(parent.getContext()), parent, false));
    }
...
class DoramaViewHolder extends RecyclerView.ViewHolder {
    private ItemDoramsBinding binding;

    public DoramaViewHolder(@NonNull ItemDoramsBinding binding) {
